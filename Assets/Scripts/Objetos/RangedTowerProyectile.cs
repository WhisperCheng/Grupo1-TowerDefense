...
public abstract class RangedTowerProyectile : MonoBehaviour, IProyectile
{
    ...
    protected void OnImpact(Collision collision)
    {
        ...
        if (enemies.Length > 0) // Recoger todos los enemigos al rededor dentro del rango de ataque en el impacto y hacerles daño
        {
        ...
        }else // Si por lo que sea el OverlapSphere no consigue recoger/devolver al menos al enemigo con el que se impactó, se aplica el daño
