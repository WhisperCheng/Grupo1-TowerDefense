...
public class EvilMagicProjectilePool : MonoBehaviour
{
    // Prefab del proyectil mágico
    public GameObject evilMagicProjectilePrefab;
    ...
    public static EvilMagicProjectilePool Instance;
    ...
    void SetupPool()
    {
        ...
        parent = new GameObject("EvilMagicProjectilePoolContainer");
        parent.transform.parent = grandParent.transform;
        // Instanciar y desactivar todos los proyectiles al inicio
        for (int i = 0; i < poolSize; i++)
        {
            projectile = Instantiate(evilMagicProjectilePrefab);
    ...
    public GameObject GetMagicProjectile(Vector3 vector3, Quaternion quaternion)
    {
        ...
        if (pool.Count == 0)
        {
            ...
            newProjectile = Instantiate(evilMagicProjectilePrefab, vector3, quaternion);
